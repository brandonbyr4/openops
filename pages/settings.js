                ...
                <section className="px-3 bg-white">
                    <div className="max-w-screen-xl mx-auto py-14">
                        ...
                        <ul className="flex-1 grid grid-cols-5 gap-x-6 gap-y-12 mt-8">
                            <SettingsCard src={google_analytics_logo} title="Google Analytics" description="Traffic analytics and user demographics" onClick={() => handleConfiguration()} />
                            <SettingsCard src={paypal_logo} title="PayPal" description="Data and analytics for PayPal transactions" onClick={() => handleConfiguration()} />
                            <SettingsCard src={stripe_logo} title="Stripe" description="Data and analytics for Stripe transactions" onClick={() => handleConfiguration()} />
                        </ul>
                    </div>
                </section>
            </main>
