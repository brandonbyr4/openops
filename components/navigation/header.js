    ...
    <div>
      ...
      <header className="fixed top-0 w-full px-3 bg-gray-100">
        <div className="flex justify-between items-center max-w-screen-xl mx-auto py-5">
          ...
          {mobileMenu ? (
            <svg
              ...
              className="md:hidden block w-6 h-6 text-gray-900 cursor-pointer"
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
              viewBox="0 0 24 24"
              strokeWidth="1.5"
        ...
        {mobileMenu ? (
          <div
            ref={mobileMenuRef}
            className="md:hidden absolute top-14 right-3 w-44 py-4 bg-white rounded shadow"
          >
            <Link
              href="/"
              className="flex gap-2 justify-center p-3 text-gray-900 hover:bg-gray-100 whitespace-nowrap"
            >
              Dashboard
              <svg
                className="w-6 h-6"
